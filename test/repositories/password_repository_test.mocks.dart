...
// in cryptowl/test/repositories/password_repository_test.dart.
...
class _FakeKdbxFormat_3 extends _i1.SmartFake implements _i3.KdbxFormat {
  _FakeKdbxFormat_3(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeKdbxReadWriteContext_4 extends _i1.SmartFake
    implements _i3.KdbxReadWriteContext {
  _FakeKdbxReadWriteContext_4(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeKdbxHeader_5 extends _i1.SmartFake implements _i4.KdbxHeader {
  _FakeKdbxHeader_5(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeKdbxBody_6 extends _i1.SmartFake implements _i3.KdbxBody {
  _FakeKdbxBody_6(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeCredentials_7 extends _i1.SmartFake implements _i5.Credentials {
  _FakeCredentials_7(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class _FakeKdbxGroup_9 extends _i1.SmartFake implements _i7.KdbxGroup {
  _FakeKdbxGroup_9(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeMergeContext_10 extends _i1.SmartFake implements _i3.MergeContext {
  _FakeMergeContext_10(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockKdbxFile extends _i1.Mock implements _i9.KdbxFile {
  ...
  @override
  _i3.KdbxReadWriteContext get ctx =>
      (super.noSuchMethod(
  ...
  @override
  _i4.KdbxHeader get header =>
      (super.noSuchMethod(
            Invocation.getter(#header),
            returnValue: _FakeKdbxHeader_5(this, Invocation.getter(#header)),
          )
          as _i4.KdbxHeader);

  @override
  _i3.KdbxBody get body =>
      (super.noSuchMethod(
            Invocation.getter(#body),
            returnValue: _FakeKdbxBody_6(this, Invocation.getter(#body)),
          )
          as _i3.KdbxBody);

  @override
  Set<_i10.KdbxObject> get dirtyObjects =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Credentials get credentials =>
      (super.noSuchMethod(
  ...
  set credentials(_i5.Credentials? credentials) => super.noSuchMethod(
    Invocation.setter(#credentials, credentials),
    returnValueForMissingStub: null,
  );

  @override
  bool get isDirty =>
      (super.noSuchMethod(Invocation.getter(#isDirty), returnValue: false)
          as bool);
  ...
  @override
  _i6.Future<_i11.Uint8List> save() =>
      (super.noSuchMethod(
  ...
  _i6.Future<T> saveTo<T>(_i9.FileSaveCallback<T>? saveBytes) =>
      (super.noSuchMethod(
            Invocation.method(#saveTo, [saveBytes]),
            returnValue:
                _i8.ifNotNull(
                ...
                _FakeFuture_8<T>(this, Invocation.method(#saveTo, [saveBytes])),
          )
          as _i6.Future<T>);

  @override
  void onSaved(_i12.TimeSequence? savedAt) => super.noSuchMethod(
    Invocation.method(#onSaved, [savedAt]),
    returnValueForMissingStub: null,
  );

  @override
  void dirtyObject(_i10.KdbxObject? kdbxObject) => super.noSuchMethod(
    Invocation.method(#dirtyObject, [kdbxObject]),
    returnValueForMissingStub: null,
  );
  ...
  @override
  _i7.KdbxGroup getRecycleBinOrCreate() =>
      (super.noSuchMethod(
            Invocation.method(#getRecycleBinOrCreate, []),
  ...
  void upgrade(int? majorVersion) => super.noSuchMethod(
    Invocation.method(#upgrade, [majorVersion]),
    returnValueForMissingStub: null,
  );

  @override
  _i3.MergeContext merge(_i9.KdbxFile? other) =>
      (super.noSuchMethod(
            Invocation.method(#merge, [other]),
